        ...
        <div className="row">
          <div className="overvission col-md-6 col-12 order-md-1 order-2 p-5">
            ...
            <h2 className="div-heading" data-aos="fade-left" data-aos-duration="1000">
              Why <b className="primary-color">Unicare Psychiatry</b> Healthcare?
            </h2>
            <p className="f-18-n custom-text-alignment container" data-aos="fade-right" data-aos-duration="1000">
              <b className="primary-color">Unicare Psychiatry</b> provides
              ...
              affordable. <b className="">Unicare Psychiatry</b> is a
              ...
              <b className="">Unicare Psychiatry</b> is a center of excellence
